...
def fct(flux, chemin_fichier_sortie):
    print("MA 2")
...
# Attention impacte le chemin de sortie
fct("http://admin.millesima.fr/media/productsfeedpick/fr.xml", '/var/www/html/Tarifs/batchs/logs/sortie_MILIMA.csv');